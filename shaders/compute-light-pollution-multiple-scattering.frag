...
#include "multiple-scattering-light-pollution.h.glsl"
...
void main()
{
    ...
    scatteringTextureOutput=computeMultipleScatteringForLightPollution(vars.cosViewZenithAngle, vars.altitude, vars.viewRayIntersectsGround);
